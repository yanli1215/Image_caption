...
parser.add_argument('--model', '-m', choices=('coco', 'conceptual'), help='pretrained model: COCO or Conceptual captions')
...
current_directory = os.getcwd() + "/image_caption"
...
# Choose pretrained model - COCO or Coneptual captions
...
for file in os.listdir(directory):
    ...
    if filename.endswith(".jpg") or filename.endswith(".png"):
        ...
        if use_beam_search:
            generated_text_prefix = generate_beam(model, tokenizer, beam_size, embed=prefix_embed)[0]
        else:
        ...
        # save to dictionary
        prediction_dict[filename] = generated_text_prefix
        continue
    else:
        continue
